...
COMMENT ON COLUMN usuarios.foco_acesso IS 'Acesso à Biblioteca FOCO (order bump)';
...
CREATE INDEX IF NOT EXISTS idx_usuarios_foco_acesso ON usuarios(foco_acesso) WHERE foco_acesso = true;
