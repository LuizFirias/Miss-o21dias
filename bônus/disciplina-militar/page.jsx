...
import StepCard from "@/components/bonus/StepCard";
...
/* ─────────────────────────────────────────────────────────
   CTA BUTTON
───────────────────────────────────────────────────────── */
function CtaButton({ isLast, onClick }) {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        >
          {isLast ? "VOLTAR PARA MISSÕES" : "CONTINUAR"}
        </span>
...
/* ─────────────────────────────────────────────────────────
   COMPLETION OVERLAY (shown briefly on last step advance)
───────────────────────────────────────────────────────── */
function CompletionFlash({ visible }) {
  return (
    <AnimatePresence>
      {visible && (
        <motion.div
...
export default function CodigoDisciplinaPage() {
  ...
  const goNext = useCallback(() => {
    if (isLast) {
      ...
      setTimeout(() => {
        setFlash(false);
        router.push("/"); // adjust to your missions route
      }, 300);
      return;
    }
    setDirection(1);
